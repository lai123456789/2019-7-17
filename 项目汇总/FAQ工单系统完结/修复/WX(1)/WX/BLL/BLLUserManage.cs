...
namespace BLL
{
    public class BLLUserManage
    {
        ...
        public bool GetWXFansBindUserInfo(string wxopenid, ref DataTable dt, ref DataTable dt1, ref string errmsg)
        {
            bool result = true;
            DALUserManage mydal = new DALUserManage();
            result = mydal.GetWXFansBindUserInfo(wxopenid, ref dt,ref dt1,ref errmsg);
            return result;
        }
        ...
        public bool Getopenid(string wxopenid, string account, ref string errmsg)
        {
            bool result = true;
            DALUserManage mydal = new DALUserManage();
            result = mydal.Getopenid(wxopenid, account, ref errmsg);
            return result;
        }
        ...
        public bool GetUsercode(string id, string account, ref string errmsg)
        {
            bool result = true;
            DALUserManage mydal = new DALUserManage();
            result = mydal.GetUsercode(id, account, ref errmsg);
            return result;
        }
    }
}
