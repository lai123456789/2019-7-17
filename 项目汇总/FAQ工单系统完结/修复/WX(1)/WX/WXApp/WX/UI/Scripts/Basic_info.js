...
$(function () {
    ...
    //before_html += '                </ul>';
    //before_html += '            </li>';
    before_html += '            <li class="dropdown visible-md visible-lg" style="margin-right:30px;">';
    before_html += '                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="userinfo"><img class="user-avatar" src="/UI/Image/head.jpg" alt="user-mail">管理员</a>';
    before_html += '                <ul class="dropdown-menu">';
    before_html += '                    <li class="dropdown-menu-header">';
    before_html += '                        <strong>账号信息：  </strong>';
    before_html += '                        <strong><span id="zh">账号信息</span></strong>';
    before_html += '                    </li>';
    before_html += '                    <li><a href="JavaScript:;" id="zhuxiao"><i class="fa fa-sign-out"></i>注销</a></li>';
    before_html += '                </ul>';
    before_html += '            </li>';
    before_html += '        </ul>';
    before_html += '    </div>';
    ...
    before_html += '                                <li><a href="/page/admin_info.html"><i class="fa fa-user"></i><span class="text">我的派工</span></a></li>';
    before_html += '                            </ul>';
    before_html += '                        </li>';
    before_html += '                        <li>';
    before_html += '                    </ul>';
...
//注销模块    
$(document).on('click', '#zhuxiao', function () {
    zhuxiao();
});
function zhuxiao() {
