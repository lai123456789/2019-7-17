<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_content.aspx.cs" Inherits="WXApp.WX.WebForm1" %>
...
<head>
    ...
    <%--<script src="comment_content.js"></script>--%>
    <script src="js/comment_content.js"></script>
    <script>
...
<body>
    ...
    <div class="weui-btn-area" id="xiugai">
        <a class="weui-btn weui-btn_warn  update">修改评价</a>
    </div>
    <div class="weui-btn-area" id="queding" style="display:none">
        <a class="weui-btn weui-btn_warn" id="queding_update">确定</a>
    </div>
</body>
</html>
