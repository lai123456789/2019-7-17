        ...
        success: function (data) {
            if (data.errcode == 0) {
                $.each(data.data, function (idx, obj) {
                    ...
                    content += '<img src="img/noavatar_big.gif" width="50px" height="50px" alt="" style="margin-top: -60px;display:flex;">';
                    content += '</div>';
                    ...
                    $(".list img:eq(2)").css("margin-left", "-15px");
            ...
            if (data.errcode == 0) { 
                if (data.data[0] != null) {
                    $.each(data.data, function (idx, obj) {   //这里开始显示问题回复的内容                     
                        ...
                        divvv += '<img src="img/noavatar_big.gif" alt="" width="50px" height="50px;">';
                        divvv += '</div>';
...
function admin_huifu() {   //微信技术员回复问题模块
    ...
    $.ajax({
        ...
        success: function (data) {            
            ...
            setTimeout(function () {
                window.location.href = "WXadmin_click_info.aspx?Wid=" + wordercode;
            }, 2000);
