...
<body>
    ...
    <div class="weui-cells">
        <div class="weui-cell">
            <div class="weui-cell__hd">
                <p class="weui-cells__title " style="font-size: 16px;"><a href="../WXadmin_href/WXadmin_href.html"><i class="fa fa-chevron-left"></i></a></p>
            </div>
            <div class="weui-cell__bd" style="text-align:center;font-size: 19px;line-height: 30px;">派工管理</div>
        </div>
    </div>
    
    <p style="float:left;" class="wei"><input type="button" class="btn btn-primary" name="name" value="查看未派工" />&nbsp;</p>
    <p class="yi"><input type="button" name="name" class="btn btn-primary" value="查看已派工" /></p>
    ...
    <div class="content_WX"></div>  <!--未派工-->
    <div class="content_WX_yi"></div>  <!--已派工-->
