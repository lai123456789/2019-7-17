                ...
                $.each(data.data1, function (idx, obj) {
                    ...
                    switch (obj.gdstate) {
                        ...
                        case "3":
                            ...
                            pingjia += '<div class="weui-cell__ft" style="color: blue"><a href="../comment_content/comment_content.html?Wid=' + wordercode + '">查看</a></div>  ';
                    ...
                    var queren = '';
                    queren += '<div class="weui-cell__ft" style="color: blue"><a href="../comment/comment.html?Wid=' + wordercode + '">确认</a></div>  ';
