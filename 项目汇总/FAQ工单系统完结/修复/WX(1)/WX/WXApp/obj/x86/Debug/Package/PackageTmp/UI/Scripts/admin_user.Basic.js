...
document.write('<link href="/assets/css/add-ons.min.css" rel="stylesheet" />');
document.write('<link href="/UI/Style/iconfont.css" rel="stylesheet" />');
document.write('<link href="/UI/Style/Basic.css" rel="stylesheet" />');
...
$(function () {
    ...
    //before_html += '                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope-o"></i><span class="badge">2</span></a>';
    //before_html += '                <ul class="dropdown-menu">';
    //before_html += '                    <li class="dropdown-menu-header">';
    //before_html += '                        <strong>消息</strong>';
    //before_html += '                        <div class="progress thin">';
    //before_html += '                            <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%">';
    //before_html += '                                <span class="sr-only">30% Complete (success)</span>';
    //before_html += '                            </div>';
    //before_html += '                        </div>';
    //before_html += '                    </li>';
    ...
    //before_html += '                            <img class="avatar" src="/UI/Image/head.jpg">';
    //before_html += '                            <div>新消息</div>';
    //before_html += '                            <small>30分钟前</small>';
    //before_html += '                        </a>';
    //before_html += '                    </li>';
    //before_html += '                    <li class="dropdown-menu-footer text-center">';
    //before_html += '                        <a href="#">查看所有信息</a>';
    //before_html += '                    </li>';
    //before_html += '                </ul>';
    //before_html += '            </li>';
    //before_html += '            <li class="dropdown visible-md visible-lg">';
    //before_html += '                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell-o"></i><span class="badge">3</span></a>';
    //before_html += '                <ul class="dropdown-menu">';
    //before_html += '                    <li class="dropdown-menu-header">';
    //before_html += '                        <strong>通知</strong>';
    //before_html += '                        <div class="progress thin">';
    //before_html += '                            <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%">';
    //before_html += '                                <span class="sr-only">30% Complete (success)</span>';
    //before_html += '                            </div>';
    //before_html += '                        </div>';
    //before_html += '                    </li>';
    ...
    //before_html += '                        <a href="#" class="notification-user"> 张三 </a>';
    //before_html += '                        <span class="notification-action">有新回复</span>';
    //before_html += '                        <a href="#" class="notification-link">查看</a>';
    //before_html += '                    </li>';
    //before_html += '                    <li class="clearfix">';
    //before_html += '                        <i class="fa fa-comment"></i>';
    //before_html += '                        <a href="#" class="notification-user"> 183216 </a>';
    //before_html += '                        <span class="notification-action">审批待处理</span>';
    //before_html += '                        <a href="#" class="notification-link">查看</a>';
    //before_html += '                    </li>';
    //before_html += '                    <li class="clearfix">';
    //before_html += '                        <i class="fa fa-comment"></i>';
    //before_html += '                        <a href="#" class="notification-user"> 184083 </a>';
    //before_html += '                        <span class="notification-action">异常待处理</span>';
    //before_html += '                        <a href="#" class="notification-link">查看</a>';
    //before_html += '                    </li>';
    //before_html += '                    <li class="dropdown-menu-footer text-center">';
    //before_html += '                        <a href="page-activity.html">查看所有信息</a>';
    //before_html += '                    </li>';
    //before_html += '                </ul>';
    //before_html += '            </li>';
    before_html += '            <li class="dropdown visible-md visible-lg">';
    before_html += '                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="userinfo"><img class="user-avatar" src="/UI/Image/head.jpg" alt="user-mail"></a>';//超级管理员（admin）
    before_html += '                <ul class="dropdown-menu">';
    before_html += '                    <li class="dropdown-menu-header">';
    before_html += '                        <strong>账号信息 ： </strong>';
    before_html += '                        <strong><span id="am"></span></strong>';
    before_html += '                    </li>';
    before_html += '                    <li><a href="JavaScript:;" id="zhuxiao1"><i class="fa fa-sign-out"></i>注销</a></li>';
    before_html += '                </ul>';
    before_html += '            </li>';
    before_html += '        </ul>';
    before_html += '    </div>';
    ...
    before_html += '                    <ul class="nav nav-sidebar">';
    //before_html += '                        <li><a href="/Page/index.html"><i class="fa fa-home"></i><span class="text">首页</span></a></li>';
    before_html += '                        <li>';
    before_html += '                            <a href="#"><i class="fa fa-cog"></i><span class="text">控制台</span> <span class="fa fa-angle-down pull-right"></span></a>';
    before_html += '                            <ul class="nav sub">';
    before_html += '                                <li><a href="/Page/admin_user.html?Wid=' + usercode + '&token=' + token + '&username=' + username + '&usertype=' + usertype + '"><i class="fa fa-user"></i><span class="text">用户管理</span></a></li>';
    before_html += '                                <li><a href="/Page/admin_info.html?Wid=' + usercode + '&token=' + token + '&username=' + username + '&usertype=' + usertype + '"><i class="fa fa-building-o"></i><span class="text">我的派工</span></a></li>';
    before_html += '                            </ul>';
    before_html += '                        </li>';
    before_html += '                        <li>';
    before_html += '                            <a href="#"><i class="fa fa-list-alt"></i><span class="text">派工</span> <span class="fa fa-angle-down pull-right"></span></a>';
    before_html += '                            <ul class="nav sub">';
    before_html += '                                <li><a href="/Page/admin_paigong.html?Wid=' + usercode + '&token=' + token + '&username=' + username + '&usertype=' + usertype + '"><i class="fa fa-building-o"></i><span class="text">查看派工</span></a></li>';
    before_html += '                            </ul>';
    before_html += '                        </li>';
    before_html += '                        <li>';
    before_html += '                    </ul>';
...
//        type: "post",
//        dataType: "json",
//        url: "http://172.27.56.4:1680/UserManage.aspx?action=LogoutUser",
//        // async: true,
//        error: function (request) {
//        },
//        success: function (data) {
