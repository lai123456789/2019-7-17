...
$(function () {
    ...
    //before_html += '            </li>';
    before_html += '            <li class="dropdown visible-md visible-lg">';
    before_html += '                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="userinfo"><img class="user-avatar" src="/UI/Image/head.jpg" alt="user-mail">管理员（admin）</a>';
    before_html += '                <ul class="dropdown-menu">';
    before_html += '                    <li class="dropdown-menu-header">';
    ...
    before_html += '                    <ul class="nav nav-sidebar" style="width:200px;">';
...
})();//注销模块    $(document).on('click', '#zhuxiao33', function () {
    zhuxiao33();
