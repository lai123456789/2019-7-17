...
$(function () {
    ...
    //before_html += '            </li>';
    before_html += '            <li class="dropdown visible-md visible-lg">';
    before_html += '                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="userinfo"><img class="user-avatar" src="/UI/Image/head.jpg" alt="user-mail">超级管理员（admin）</a>';
    before_html += '                <ul class="dropdown-menu">';
    before_html += '                    <li class="dropdown-menu-header">';
    ...
    before_html += '                                <li><a href="/Page/admin_user.html"><i class="fa fa-user"></i><span class="text">用户管理</span></a></li>';
    before_html += '                            </ul>';
    before_html += '                        </li>';
    before_html += '                        <li>';
    before_html += '                            <a href="#"><i class="fa fa-list-alt"></i><span class="text">派工</span> <span class="fa fa-angle-down pull-right"></span></a>';
    before_html += '                            <ul class="nav sub">';
    before_html += '                                <li><a href="/Page/admin_paigong.html"><i class="fa fa-building-o"></i><span class="text">查看派工</span></a></li>';
    before_html += '                            </ul>';
    before_html += '                        </li>';
    before_html += '                        <li>';
    before_html += '                    </ul>';
