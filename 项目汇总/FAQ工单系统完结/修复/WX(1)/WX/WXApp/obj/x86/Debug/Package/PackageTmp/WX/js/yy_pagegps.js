...
add_page += '<li class="page-item"><input type="text" style="height:27px;"><span style="color:#428BCA;float:right;height:26px;">页</span><a href="javascript:;" class="butn">跳至</a></li>';
add_page += '<span style="margin-left:20px;">共 <b class="all"></b> 页</span>';//第 <b class="number" style="color:red;">1</b> 页
add_page += '</ul>';
add_page += '</div>';
add_page += '</div>';
