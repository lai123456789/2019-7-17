...
<body>
    ...
    <input type="hidden" name="name" value="<%=username%>" id="username"/> <%--获取usercode--%>
    <input type="hidden" name="name" value="<%=usertype%>" id="usertype"/> <%--获取usertype--%>
    <div class="quan">
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__hd" id="bd">
                    <p style="font-size: 19px;"><a href="gongdan_server_info.aspx" class="weui-cells__title"><i class="fa fa-chevron-left"></i></a></p>
                </div>
