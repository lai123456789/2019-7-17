...
$(function () {
    ...
    var divvv1 = '';
    divvv1 += '<li class="level-1-item">';   //获取id值
    divvv1 += '<a class="toggle-item" href="create_gongdan.html?Wid=' + usercode + '&token=' + token + '&username=' + username + '">';
    divvv1 += ' <i class="iconfont"></i>';
    divvv1 += '<span>创建工单</span>';
    divvv1 += '</a>';
    divvv1 += '</li>';
    divvv1 += '<li class="level-1-item active">';
    divvv1 += '<a class="toggle-item" href="gongdan_list.html?Wid=' + usercode + '&token=' + token + '&username=' + username + '">';
    divvv1 += '<i class="iconfont"></i>';
    divvv1 += '<span>工单分页列表</span>';
    divvv1 += ' </a>';
    divvv1 += '</li>';
    $("#index").empty();
    $("#index").append(divvv1);
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.errcode == 0) {
                alert("删除成功!!!");
                //GetInfoWordOrder(wordercode);
                window.location.href = "gongdan_list.html?Wid="+usercode+'&username='+username+'&token='+token;
            }
        }
    });
});
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.errcode == "#code#") {
                ...
                $('#fl').empty();                
                $('#fl').append(username + "<span class=\"time\">" + time + "</span><br/><span id='tupian'><img src=http://o24034e466.qicp.vip/" + img + " alt=' '>&nbsp;<img src=http://o24034e466.qicp.vip/" + img1 + " alt=' '>&nbsp;&nbsp;<img src=http://o24034e466.qicp.vip/" + img2 + "  alt=' ' /></span>");//data.User+"&nbsp;&nbsp;"+obj.CREATETIME
