...
add_page += '<ul class="jump pagination">';
add_page += '<li class="page-item"><a href="javascript:;" class="butn page-link">跳至</a><input type="text" value="" autocomplete="off"><a href="javascript:;" class="butn" style="float:right">确认</a></li>';
add_page += '</ul>';
add_page += '<ul class="pre pagination">';
add_page += '<li class="page-item"><a href="javascript:;" class="butn page-link"> ← 上一页</a></li>'; 
add_page += '</ul>';
add_page += '<ul class="num pagination">';
add_page += '</ul>';
add_page += '<ul class="next pagination"><li class="page-item"><a href="javascript:;" class="butn page-link">下一页 → </a></li>';
//add_page += '<span style="margin-left:10px;color:#1FB2E5">第 <b class="number" style="color:red;">1</b> 页 / 共 <b class="all"></b> 页</span>';
add_page += '<span style="margin-left:10px;margin-top:20px;color:#1FB2E5;border:1px solid #1FB2E5;">共 <b class="all"></b> 页</span>';
