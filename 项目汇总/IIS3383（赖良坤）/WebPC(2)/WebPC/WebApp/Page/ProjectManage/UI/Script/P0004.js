...
$(function () {
    ...
    if (pj != null && pj != '') {
        ...
        全局搜索 = search;
        全局页码 = 1;
        GetUserList("IIS", "BusinessManage/AssemblyManage.aspx?action=getuserskills", {
            "page": 1,
            "search": search
        });
    }
...
$(document).on('click', '#add_sure', function () {
    ...
    AddAssemblyOrderInfo("IIS", "BusinessManage/AssemblyManage.aspx?action=setuserskills", {
        "usercode": 用户代码,
        "skills": 职能列表
    });
});
