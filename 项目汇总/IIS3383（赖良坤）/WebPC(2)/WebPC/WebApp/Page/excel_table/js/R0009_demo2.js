...
var tableVal = [];
$(function () {
    onload = function () {  //页面一开始打开就展示  demo2    的内容

        $.ajax({
            url: "http://192.168.2.197:3382/UserManage.aspx?action=GetEXB",
            type: 'GET',
            dataType: 'json',
...
function getDrawing(明细) {
    var dataarr = { "data": 明细, };
    去重1('IIS3382', '/UserManage.aspx?action=UpdateExcleB', 明细, function () {
    });
}
