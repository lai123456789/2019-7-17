...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _change: function (e) {
            //可以在这里修改选择图片确定时样式
            if ($(".file-preview-frame").hasClass("contor")) {
        ...
        readFiles: function (files) {
            ...
            readFile = function (i) {
                ...
                if (self.isAjaxUpload && self.fileManager.exists(fileId)) {  //这里限制不上传重复的图片
    ...
    $.fn.fileinputLocales.en = {
       ...
       // msgDuplicateFile: 'ABCDEFG',//File "{name}" of same size "{size} KB" has already been selected earlier. Skipping duplicate selection.
