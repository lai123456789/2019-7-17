...
//----------------------------UPLOADFILES------------------------------------
            ...
            if (thisS.options.preview) {
                var getTemplate = function (content) {
                    return '<table class="ssi-imgToUploadTable ssi-pending">' +
                     ...
                     '<tr><td><button data-delete="' + index + '" class=" ssi-button error ssi-removeBtn"><span class="trash10 trash"><i class="fa fa-trash-o"></i></span></button></td></tr>' +
    ...
    var locale = {
        ...
        gr: {
            success: '螘蟺喂蟿蠀蠂委伪',
            sucUpload: '螘蟺喂蟿蠀蠂萎蟼 渭蔚蟿伪蠁蠈蟻蟿蠅蟽畏',
            chooseFiles: '螘蟺喂位苇尉蟿蔚 伪蟻蠂蔚委伪',
            uploadFailed: '螚 渭蔚蟿伪蠁蠈蟻蟿蠅蟽畏 伪蟺苇蟿蠀蠂蔚!',
            serverError: '螘蟽蠅蟿蔚蟻喂魏蠈 蟽蠁维位渭伪 未喂伪魏慰渭喂蟽蟿萎!',
            error: '危蠁维位渭伪',
            abort: '螖喂伪魏慰蟺萎',
            aborted: '螖喂伪魏蠈蟺畏魏蔚',
            files: '伪蟻蠂蔚委伪',
            ...
            clear: '螘魏魏伪胃维蟻喂蟽畏',
            drag: '危蠀蟻蔚蟿蔚 蔚未蠋...',
            sizeError: '$1 苇蠂蔚喂 尉蔚蟺蔚蟻维蟽蔚喂 蟿慰 蠈蟻喂慰 蟿蠅谓 $2.',// $1=file name ,$2=max file size ie( example.jpg has has exceed the size limit of 2mb)
            extError: '$1 伪蟻蠂蔚委伪 未蔚谓 蠀蟺慰蟽蟿畏蟻委味慰谓蟿伪喂.',// $1=file extension ie(exe files are not supported)
            someErrorsOccurred: '危畏渭蔚喂蠋胃畏魏伪谓 慰蟻喂蟽渭苇谓伪 位维胃畏!'
        }
    };
