...
namespace BLL
{
    public class BLLUserManage
    {
        ...
        #region Mcally 3676本地测试数据库的异常信息记录(重新设置代理)
        ...
        /// <param name="errmsg">出错时返回的错误提示信息</param>
        /// <returns>是否成功执行</returns>
        public bool GetUserUnNotifyV2(string usercode, ref string json, ref string errmsg)
        {
            bool result = true;
            try
            {
        ...
        /// <param name="errmsg">出错时返回的错误提示信息</param>
        /// <returns>是否成功执行</returns>
        public bool GetUserTaskNotifyV2(string usercode, ref string json, ref string errmsg)
        {
            bool result = true;
            try
            {
        ...
        /// <param name="errmsg">出错时返回的错误提示信息</param>
        /// <returns>是否成功执行</returns>
        public bool GetMyTaskUnfinishedListV2(string usercode, ref string json, ref string errmsg)
        {
            bool result = true;
            try
            {
        ...
        /// <param name="errmsg">出错时返回的错误提示信息</param>
        /// <returns>是否成功执行</returns>
        public bool SetUserReadNotifyV2(string usercode, string notifycode, ref string json, ref string errmsg)
        {
            bool result = true;
            try
            {
