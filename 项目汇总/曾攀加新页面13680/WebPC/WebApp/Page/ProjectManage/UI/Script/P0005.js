...
$(document).on('click', '#add_sure', function () {
    ...
    AddInfo("IIS3676", "BusinessManage/AssemblyManage.aspx?action=addprocessleader", {
        "account": account,
        "flowcode": flowcode
    });
});
...
$(document).on('click', '#datalist2 > .panel-heading > .sava.contor', function () {
    ...
    SavaRoleInfo("IIS3676", "AuthorityManage.aspx?action=roleauthority", {
        "rolecode": rolecode,
        "rolepage": rolepage,
        "usercode": ""
    });
...
$(document).on('click', '#form_tb > tr', function () {
    ...
    GetRolePageList("IIS3676", "BusinessManage/AssemblyManage.aspx?action=getprocessleader", {
        "flowcode": flowcode,
        "search": "",
        "page": 1
    });
