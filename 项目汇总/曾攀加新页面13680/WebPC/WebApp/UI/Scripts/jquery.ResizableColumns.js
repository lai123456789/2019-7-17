...
(function($, window) {
  ...
  ResizableColumns = (function() {
    ...
    function ResizableColumns($table, options) {
      ...
      this.$table = $table;
      //this.tableId = this.$table.data('id');
    ...
    ResizableColumns.prototype.syncHandleWidths = function() {
      var _this = this;
        ...
        //this.$handleContainer.css('min-width', this.$table.width() + 'px');
        //this.$handleContainer.css('width', this.$table.width() + 'px');-
    ...
    ResizableColumns.prototype.restoreColumnWidths = function() {
      ...
      return this.$table.find('tr th').each(function(_, el) {
        ...
        if ((_this.options.store != null) && (width = store.get(id))) {
            ...
            //return $(el).css('min-width', width + 'px');
        }
      });
    };
    ...
    ResizableColumns.prototype.mousedown = function(e) {
      ...
      $(document).on('mousemove.rc', function(e) {
        ...
        //$leftColumn.css('min-width', newLeftColumnWidth + 'px');-
          //$rightColumn.css('min-width', newRightColumnWidth + 'px');-

        //$leftColumn.css('width', newLeftColumnWidth + 'px');
        //$rightColumn.css('width', newRightColumnWidth + 'px');
        return _this.syncHandleWidths();
      });
