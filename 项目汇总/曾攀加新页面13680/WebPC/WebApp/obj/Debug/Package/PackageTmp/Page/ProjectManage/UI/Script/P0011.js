...
var page = 1, onetype = '', oneval = '', datetype = '', startdate = '', enddate = '',
    sortfield = '', sort = '', numbertype = '', numbership = '', numberval = '', storagecode='';

var PORT = "IIS3676";
var URL = "Warehouse/UnmannedWarehouse.aspx?action=";
$(function () {
      storagecode = getQueryString('storagecode');
      GetMainList(PORT, URL + "getstorageDocumentDetailPCList", Getseach());
});
...
$(document).on('click', '#form_th > tr > th', function () {
    ...
    GetMainList(PORT, URL + "getstorageDocumentDetailPCList", Getseach(), page);
});
/*开启表格【全屏放大】模态窗口*/
