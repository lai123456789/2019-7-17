...
var 全局页码 = 1;
$(function () {
    GetList("IIS", "ReportTable/SlamaterialAreport.aspx?action=getslamaterialareportzp", {
        "page": 1,
        "search": 全局搜索
    });
})
...
$(document).on('click', '#add_sure', function () {
    ...
    AddInfo("IIS", "ReportTable/SlamaterialAreport.aspx?action=addslamaterialareportzp", {
...
$(document).on('click', '#set_sure', function () {
    ...
    SetInfo("IIS", "ReportTable/SlamaterialAreport.aspx?action=setslamaterialareportzp", {
        "reportdate": reportdate,
        "ordernum": ordernum,
        "materialnum": materialnum,
        "condition": condition,
