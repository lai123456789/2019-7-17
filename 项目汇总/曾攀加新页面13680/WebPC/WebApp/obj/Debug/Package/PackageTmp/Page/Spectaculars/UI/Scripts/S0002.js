            ...
            if (data.errcode == 0) {
                ...
                $.each(data.data1, function (idx, obj) {
                    if (idx < 行数) {
                        ...
                        if (idx == 0) {
                            ...
                            content += '    <td class="wd_40">' + obj.订单数.trim() + '</td>';
                            content += '    <td class="wd_50">' + obj.材料款数.trim() + '</td>';
                            content += '    <td class="wd_140">' + obj.当前状况.trim().replace(/\n/g, "<br />") + '</td>';
                            content += '    <td class="wd_80">' + obj.预计交付日期.trim().replace(/\n/g, "<br />") + '</td>';
                            content += '    <td class="wd_130">' + obj.sla交付影响.trim().replace(/\n/g, "<br />") + '</td>';
                            content += '    <td class="left_red wd_100">' + obj.异常事项.trim().replace(/\n/g, "<br />") + '</td>';
                            content += '    <td class="wd_90">' + obj.协调事项.trim().replace(/\n/g, "<br />") + '</td>';
                            content += '    <td class="right_red wd_100">' + obj.今日重点事项.trim().replace(/\n/g, "<br />") + '</td>';
                ...
                for (var i = num1; i < 行数; i++) {
                    if (i == 0) {
                        ...
                        content += '    <td class="wd_140"></td>';
                        content += '    <td class="wd_80"></td>';
                        content += '    <td class="wd_130"></td>';
                        content += '    <td class="left_red wd_100"></td>';
                        content += '    <td class="wd_90"></td>';
                        content += '    <td class="right_red wd_100"></td>';
                        content += '    <td class="wd_50"></td>';
                        content += '</tr>';
                    }
                    else {
                ...
                var num6 = 0;
                $.each(data.data6, function (idx, obj) {
                    if (idx < 行数) {
                        num6++;
                        if (idx == 0) {
                            content += '<tr>';
                ...
                for (var i = num6; i < 行数; i++) {
                    if (i == 0) {
                        content += '<tr>';
                        content += '    <td rowspan="' + 行数 + '" style="vertical-align: middle;" class="wd_30">事业2部</td>';
                        content += '    <td class="wd_60"></td>';
                        content += '    <td class="wd_40"></td>';
                        content += '    <td class="wd_50"></td>';
                        content += '    <td class="wd_140"></td>';
                ...
                $.each(data.data4, function (idx, obj) {
                    if (idx < 行数) {
                        ...
                        if (idx == 0) {
                            ...
                            content += '    <td class="wd_90">' + obj.协调事项.trim().replace(/\n/g, "<br />") + '</td>';
                            if (i == 5) {
                                content += '    <td class="right_red bottom_red wd_100">' + obj.今日重点事项.trim().replace(/\n/g, "<br />") + '</td>';
                            } else {
                                content += '    <td class="right_red wd_100">' + obj.今日重点事项.trim().replace(/\n/g, "<br />") + '</td>';
                            }
                            content += '    <td class="wd_50">' + GetDateFormat(obj.更新时间, 'yyyy-MM-dd') + '</td>';
                ...
                for (var i = num4; i < 行数; i++) {
                    if (i == 0) {
                        ...
                        content += '    <td class="wd_130"></td>';
                        if (i == 5) {
                            content += '    <td class="left_red bottom_red wd_100"></td>';
                            content += '    <td class="bottom_red wd_90"></td>';
                            content += '    <td class="right_red bottom_red wd_100"></td>';
                        } else {
                            content += '    <td class="left_red wd_100"></td>';
                            content += '    <td class="wd_90"></td>';
                            content += '    <td class="right_red wd_100"></td>';
