<%@ Page Title="" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="VehicleDispatchingAudit.aspx.cs" Inherits="WXApp.CarAudit.VehicleDispatchingAudit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="UI/Styles/VehicleDispatchingAudit.css?20190423" rel="stylesheet" />
    <script src="UI/Scripts/VehicleDispatchingAudit.js?20190423"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="approval_modal">
        <div class="top_title">
            ...
            <div class="right">
                <select id="selectcar">
                    <option value="mt000001">林展浩</option>
                    <option value="mt000002">杨晓龙</option>
                    <option value="mt000003">陈良忠</option>
                </select>
            </div>
        </div>
        <div class="content">
