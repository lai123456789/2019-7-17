<%@ Page Title="派车审批列表" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="VehicleOrderAudit.aspx.cs" Inherits="WXApp.CarAudit.VehicleOrderAudit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="UI/Styles/VehicleOrderAudit.css?20190423" rel="stylesheet" />
    <script src="UI/Scripts/VehicleOrderAudit.js?20190423"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="approval_modal">
        <div class="top_title">
            ...
            <div class="right">
                <select id="selectcar">
                    <%--<option value="mt00001">林展浩</option>
                    <option value="mt00002">杨晓龙</option>
                    <option value="mt00003">陈良忠</option>--%>
                </select>
            </div>
        </div>
        <div class="content">
