<%@ Page Title="我的派车审核单明细" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="VehicleOrderAuditDetails.aspx.cs" Inherits="WXApp.CarAudit.VehicleOrderAuditDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="UI/Styles/VehicleOrderAuditDetails.css?2019041112113" rel="stylesheet" />
    <script src="UI/Scripts/VehicleOrderAuditDetails.js?2019101411123"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="infodata">
        ...
        <div class="rows7">
            <div class="left">申请车辆：</div>
            <div class="right">粤S8WN86</div>
        </div>
        <div class="rows8">
        ...
        <div class="rows9">
            <div class="left">派送司机：</div>
            <div class="right">XXX（1585555XXXX）</div>
        </div>
        <div class="rows10">
...
<%--    <div id="approval_modal">
       ...
       <div id="undo_modal">
        ...
        <div id="undo_moda2">
        <div class="content">
            <textarea id="remark2" placeholder="请输入备注说明"></textarea>
        </div>
        <div class="bottom">
            <div class="btn_cancel">取消</div>
            <div class="btn_sure">确定驳回</div>
