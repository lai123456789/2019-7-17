...
$(document).on('tap', '#topinfo > .box1', function (e) {
    ...
    用户查询('IIS3382', '/Proposer.aspx?action=GetApplyPL', {
        "usercode": code,
        "page":page
    });
});
...
$(document).on('tap', '#infodata > .list1 > .infolist > .right > .box2 > .details_btn', function (e) {
    ...
    location.href = 'VehicleOrderDetails.aspx?type=' + 状态 + "&" + 'pcode=' + pcode;
});
                ...
                if ($('#topinfo > .box1.contor').text() == "全部") {
                    $.each(data.data, function (idx, obj) {
                        ...
                        if (obj.status == 0) {
                            ...
                            content += '         <div class="box2">';
                            content += '             <div class="details_btn" data-code="' + obj.applycode + '">详情</div>';
