<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="success_application.aspx.cs" Inherits="WXApp.WX.use_car.success" %>
...
<body>
    ...
    <div class="weui-cells weui-cells_form">
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="number" placeholder="请输入初始公里数"/>
                </div>
    ...
    <div style="width:100%;display:flex;justify-content:center">
        <div class="weui-btn-area" style="width:50%;">
                    <a class="weui-btn" id="sure_application" style="background: #E3934B;cursor:pointer">立即用车</a>
        </div>
    </div>
