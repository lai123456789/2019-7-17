    ...
    g.Scroller = function (aj, al, F) {
        ...
        ac._generateContent = function () {
            ...
            h.each(ae.wheels, function (aq, ap) {
                s += '<div class="mbsc-w-p dwc' + (ae.mode != "scroller" ? " dwpm" : " dwsc") + (ae.showLabel ? "" : " dwhl") + '">';
                //if (ae.wheels.length == 1 && ap.length == 2) {
                //    s += '<div style="width: 50%;text-align: center;position: absolute;left: 0;padding-left: .3rem;padding-top: .15rem;padding-bottom: .1rem;border-bottom: 1px solid #ddd;font-size: .42rem;color: #888;">时</div>';
                //    s += '<div style="width: 50%;text-align: center;position: absolute;right: 0;padding-right: 0.2rem;padding-top: .15rem;padding-bottom: .1rem;border-bottom: 1px solid #ddd;font-size: .42rem;color: #888;">分</div>';
                //}
                //else if (ae.wheels.length == 2 && ap.length == 3) {
                //    isall = true;
                //}
                s += '<div class="dwwc"' + (ae.maxWidth ? "" : ' style="max-width:600px;"') + ">" + (a ? "" : '<table class="dw-tbl" cellpadding="0" cellspacing="0"><tr>');
                
                h.each(ap, function (at, ar) {
                    C[p] = ar;
                    ao = ar.label !== f ? ar.label : at;
                    s += "<" + (a ? "div" : "td") + ' class="dwfl" style="' + (ae.fixedWidth ? ("width:" + (ae.fixedWidth[p] || ae.fixedWidth) + "px;") : (ae.minWidth ? ("min-width:" + (ae.minWidth[p] || ae.minWidth) + "px;") : "min-width:" + ae.width + "px;") + (ae.maxWidth ? ("max-width:" + (ae.maxWidth[p] || ae.maxWidth) + "px;") : "")) + '">';
                    //if (isall) {
                    //    s += '<div>' + ar.label + '</div>';
                    //}
                    var typename = '';
