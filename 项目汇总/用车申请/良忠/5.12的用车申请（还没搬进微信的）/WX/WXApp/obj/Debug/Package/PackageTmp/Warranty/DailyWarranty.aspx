<%@ Page Title="" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="DailyWarranty.aspx.cs" Inherits="WXApp.Warranty.DailyWarranty" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="UI/Scripts/DailyWarranty.js?201904151111111111111"></script>
    <link href="UI/Styles/DailyWarranty.css?20190415111111111111" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="pageone">
        <div class="content" id="div_form_table">
            <%--<div class="infolist">
                <div class="maininfo">
                    <div class="rows1">
                    ...
                    <div class="rows2">
                        <div class="left">
                            <div class="box1">192670</div>
                            <div class="box2">长安OPPO一厂</div>
                        </div>
                        <div class="mid">
                            <div class="box1">指定同事</div>
                        </div>
                        <div class="right">
                            <div class="box1">2019/04/17</div>
                        </div>
                    </div>
                    <div class="rows3">
                        <div class="box1">配件需求：螺母，压底座一个，排插一个，防静电手套一个，静电检测仪一套</div>
                        <div class="box3">
                            <i class="iconfont">&#xe784;</i>
                        </div>
                    </div>
        ...
        <div id="bottom_footer">
            <div class="left">
                <div class="box1 contor">添加</div>
            </div>
            <div class="mid">
                <div class="box1">编辑</div>
            </div>
            <div class="mid2">
                <div class="box1">删除</div>
            </div>
            <div class="right">
                <div class="box1">提交</div>
            </div>
        </div>
    </div>
   ...
   <%--  <div id="mask300">
    ...
    <select id="modulestatus" style="position: fixed;width: 0px;height: 0px;top: 1rem;"></select>

    <select id="modulestatus1" style="position: fixed;width: 0px;height: 0px;top: 1rem;"></select>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div id="pagethree" data-role="page" >
        <div class="content">
            <div class="row1">
                <div class="box1">设备编号</div>
                <div class="symbol">：</div>
                <div class="box2">
                    <input type="text" value="" placeholder="请输入设备编码" onkeyup="wordStatic(this);"/>
                </div>
                <div class="box3">
                    <i class="iconfont">&#xe750;</i>
                </div>
            ...
            <div class="row2">
                ...
                <div class="symbol">：</div>
                <div class="box2">
                    <input type="text" value="" placeholder="请输入设备名称"  onkeyup="nameStatic(this);"/>
                </div>
                <div class="box3">
                    <i class="iconfont">&#xe750;</i>
                </div>
