<%@ Page Language="C#"  MasterPageFile="~/WXMaster.Master"  AutoEventWireup="true" CodeBehind="return_car.aspx.cs" Inherits="WXApp.WX.use_car.return_car" %>
    ...
    <div class="weui-cells weui-cells_form">
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input id="num" class="weui-input" type="number" placeholder="请输入还车公里数"/>
                </div>
