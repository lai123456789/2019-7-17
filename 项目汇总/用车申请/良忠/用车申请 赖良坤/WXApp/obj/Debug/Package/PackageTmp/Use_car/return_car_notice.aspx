<%@ Page Language="C#"  MasterPageFile="~/WXMaster.Master"  AutoEventWireup="true" CodeBehind="return_car_notice.aspx.cs" Inherits="WXApp.WX.use_car.return_car_notice" %>
...
<!-- <script src="js/example.js"></script> -->  
    ...
    <script src="script/return_car_notice.js"></script>
    <style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="weui-cells weui-cells_form" style="background:#E3934B;margin-top: 0px;">
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd" style="text-align:center;color: white">申请人还车通知</div> <%--这是申请人收到的--%>
