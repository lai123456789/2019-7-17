...
namespace BLL
{
    public class PalmAPIHelper
    {
        ...
        public static string PalmCoreAPI(string url, Dictionary<string, string> postData, string requestmethod)
        {
            ...
            string api_code = System.Configuration.ConfigurationManager.AppSettings["Call_CoreApiCode"];//调用FAQ接口所需的Code
            string api_key = System.Configuration.ConfigurationManager.AppSettings["Call_CoreApiKey"];//调用FAQ接口所需的Key
