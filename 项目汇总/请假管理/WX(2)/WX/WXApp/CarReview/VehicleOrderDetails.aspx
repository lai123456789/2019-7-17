<%@ Page Title="" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="VehicleOrderDetails.aspx.cs" Inherits="WXApp.CarReview.VehicleOrderDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="UI/Styles/VehicleOrderDetails.css" rel="stylesheet" />
    <script src="UI/Scripts/VehicleOrderDetails.js"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="operation_btn6">
      ...
      <div id="undo_moda2">
       ...
       <div id="undo_moda3">
        <div class="content">
            <textarea id="remark3" placeholder="请输入撤销原因"></textarea>
        </div>
        <div class="bottom">
            <div class="btn_cancel">取消</div>
            <div class="btn_sure">确定提交</div>
