...
<%@ Page Title="经理审核详情" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="DepartmentManager_info.aspx.cs" Inherits="WXApp.WX_LeaveManage.DepartmentManager_info" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="UI/Styles/DepartmentManager_info.css" rel="stylesheet" />
    <script src="UI/Scripts/DepartmentManager_info.js"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="approval_modal">
     ...
     <div id="approval_moda2">

        <div class="top_title">
            <div class="left">选择车辆：</div>
            <div class="right">
                <select id="selectcar1">
        ...
        <div class="content">
            <textarea id="approval_remark1" placeholder="请输入重新选车说明" onkeyup="isempty()"></textarea>
        </div>
      
        <div class="bottom">
            <div class="btn_cancel">取消</div>
            <div class="btn_sure">确定重选</div>
        </div>
    </div>
