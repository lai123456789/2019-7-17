...
$(document).on('tap', '#infodata > .list1 > .infolist > .right > .box2 > .details_btn', function (e) {
    ...
    location.href = 'DepartmentManager_info.aspx?type=' + 状态 + "&" + 'pcode=' + pcode;
});
                ...
                if ($('#topinfo > .box1.contor').text() == "全部") {
                    $.each(data.data, function (idx, obj) {
                        ...
                        if (obj.status == 0) {
                            ...
                            content += '           ' + obj.applycode + '</div>'; //请假申请单号
                            content += '          <div class="box3">';
                            content += '          ' + obj.applyname + '</div>'; //请假人
                            ...
                            content += '          <div class="box2">';
                            content += '             事假';//' + obj.endsite + '  请假类别
                            content += '             </div>';
                            content += '          <div class="box3">';
                            content += '             回家探亲 '; //' + obj.purpose + '   请假原因
                            content += '              </div>';
                            content += '      </div>';
                        ...
                        if (obj.status == 1) {
                            ...
                            content += '          <div class="box2">';
                            content += '              <div class="status status2">已审批</div>';
                            content += '          </div>';
                            content += '      </div>';
                            content += '      <div class="mid">';
                            content += '          <div class="box1">';
