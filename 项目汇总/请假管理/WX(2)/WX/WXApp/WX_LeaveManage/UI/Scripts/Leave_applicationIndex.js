...
$(document).on('tap', '#infodata > .list1 > .infolist > .right > .box2 > .details_btn', function (e) {
    ...
    location.href = 'Leave_application_info.aspx?type=' + 状态 + "&" + 'pcode=' + pcode;
});
/*
销假按钮
*/
var 单号 = "";
$(document).on('tap', '#infodata > .list1 > .infolist > .right > .box2 > #xiaojia', function (e) {
    stopDefault(e);
    
    $('#mask400').addClass('contor');
    
    $('#undo_modal_xiaojia').addClass('contor');
...
取消销假按钮
*/
$(document).on('tap', '#undo_modal_xiaojia > .bottom > .btn_cancel', function (e) {
    stopDefault(e);
    $('#undo_modal_xiaojia').removeClass('contor');
    setTimeout(function () {
        $('#mask400').removeClass('contor');
    }, 350);
                ...
                if ($('#topinfo > .box1.contor').text() == "全部") {
                    $.each(data.data, function (idx, obj) {
                        ...
                        if (obj.status == 0) {
                            ...
                            content += '            开始时间：' + GetDateFormat(obj.servicetime, 'MM-dd HH:mm') + '</div>';
                            content += '         <div class="box2">';
                            content += '            回家探亲</div>'; //' + obj.endsite + '  请假原因
                            content += '     </div>';
                            content += '     <div class="right">';
                            content += '         <div class="box1">';
                            content += '             结束时间：' + GetDateFormat(obj.returntime, 'MM-dd HH:mm') + '</div>';
                            content += '         <div class="box2">';
                        ...
                        if (obj.status == 1) {
                            ...
                            //content += '         </div>';
                            content += '         <div class="box2">';
                            content += '             <div class="status status2">已审核</div>';
                            content += '         </div>';
                            content += '     </div>';
                            content += '     <div class="mid">';
                            content += '         <div class="box1">';
                            ...
                            content += '         <div class="box2">';
                            content += '             <div class="details_btn">详情</div>';
                            content += '             <div class="undo_btn" id="xiaojia">销假</div>';
                            content += '         </div>';
                            content += '     </div>';
                            content += ' </div>';
