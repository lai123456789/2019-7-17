<%@ Page Title="" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="GetWarranty.aspx.cs" Inherits="WXApp.Warranty.GetWarranty" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="UI/Scripts/GetWarranty.js?2016429111"></script>
    <link href="UI/Styles/GetWarranty.css?2016429111" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form_design" action="/Warranty/GetWarrantyInfos.aspx?action=processed" target="_self" method="post">
