<%@ Page Title="" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="UpdateWarranty.aspx.cs" Inherits="WXApp.Warranty.UpdateWarranty" %>
<asp:Content ID="Content4" ContentPlaceHolderID="head" runat="server">
    <link href="UI/Styles/UpdateWarranty.css?201903290171451111111111111" rel="stylesheet" />
    <script src="UI/Scripts/UpdateWarranty.js?2019032901714511111111111111"></script>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <i class="iconfont" data-url="/Warranty/Processed.aspx">&#xe64e;</i>
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <input id="usercode" type="hidden" value="<%=usercode %>" />
    <input id="username" type="hidden" value="<%=username %>" />
    <input id="salescode" type="hidden" value="<%=售后代码 %>" />
    <input id="dealusercode" type="hidden" value="<%=dealusercode %>" />        
        <div id="pagethree">
        <div class="content">
            <div class="row1">
