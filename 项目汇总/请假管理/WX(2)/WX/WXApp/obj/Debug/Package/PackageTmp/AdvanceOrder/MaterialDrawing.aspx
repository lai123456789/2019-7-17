<%@ Page Title="" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="MaterialDrawing.aspx.cs" Inherits="WXApp.AdvanceOrder.MaterialDrawing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="UI/Styles/MaterialDrawing.css" rel="stylesheet" />
    <script src="UI/Scripts/MaterialDrawing.js"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form_design1" action="/AdvanceOrder/SelectMaterial.aspx?action=design" target="_self" method="post">
