$(function () {
    ...
    switch (类型) {
        ...
        case "7":
            ...
            // $('#operation_btn7').removeClass('contor');
            break;
    }
...
$(document).on('tap', '#undo_modal > .bottom > .btn_sure1', function () {
    ...
    var code = $('#usercode').val();
    //这里调用Ajax方法
    提交用车公里('IIS3382', '/Proposer.aspx?action=PAppli', {
        "applycode": 撤销单号,
        "begin": 公里数,
        "usercode": code
    });
...
$(document).on('tap', '#undo_moda2 > .bottom > .btn_sure', function () {
    ...
    var co = $('#usercode').val();
    //这里调用Ajax方法
    提交还车公里('IIS3382', '/Proposer.aspx?action=SendReturn', {
        "applycode": 撤销单号,
        "endplay": 公里数,
        "usercode": co
    });
...
$(document).on('tap', '#operation_btn4 > .submit_btn', function () {
    ...
    location.href = 'VehicleDispatching.aspx';
});
        ...
        success: function (data) {
            if (data.errcode == 0) {
                ...
                if (confirm(data.errmsg + "你确定提交吗？")) {
                    ...
                    var code = $('#usercode').val();
                    //这里调用Ajax方法
                    提交用车公里('IIS3382', '/Proposer.aspx?action=PApplis', {
                        "applycode": 撤销单号,
                        "begin": 公里数,
                        "usercode": code
                    });
