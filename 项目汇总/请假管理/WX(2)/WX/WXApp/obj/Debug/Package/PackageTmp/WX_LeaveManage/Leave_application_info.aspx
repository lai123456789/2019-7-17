<%@ Page Title="我的请假申请单详情" Language="C#" MasterPageFile="~/WXMaster.Master" AutoEventWireup="true" CodeBehind="Leave_application_info.aspx.cs" Inherits="WXApp.WX_LeaveManage.Leave_application_info" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="UI/Styles/Leave_application_info.css" rel="stylesheet" />
    <script src="UI/Scripts/Leave_application_info.js"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="operation_btn2">
        <div class="submit_btn1">申请销假</div>
