            ...
            if (data.errcode == 0) {
                ...
                $.each(data.data, function (idx, obj) {
                    if (obj.status == 0) {  //请假未审核
                        ...
                        content += '        <div class="left">职务：</div>';
                        content += '        <div class="right">技术员</div>';//' + obj.endsite + '
                        content += '    </div>';
                        content += '    <div class="rows5">';
                        content += '        <div class="left">请假类别：</div>';
                        content += '        <div class="right">事假</div>';
                        content += '    </div>';
                        content += '    <div class="rows5">';
                        content += '        <div class="left">请假原因：</div>';
                        content += '        <div class="right">回家探亲</div>';
                        content += '    </div>';
                        content += '    <div class="rows6">';
                        content += '        <div class="left">开始时间：</div>';
                        content += '        <div class="right">' + obj.servicetime + '</div>';
                        content += '    </div>';
                        content += '    <div class="rows6">';
                        content += '        <div class="left">结束时间：</div>';
                        content += '        <div class="right">' + obj.returntime + '</div>';
                        content += '    </div>';
                        content += '    <div class="rows5">';
                        content += '        <div class="left">请假时长：</div>';
                        content += '        <div class="right">5时0分</div>';
                        content += '    </div>';
                        content += '    <div class="rows8">';
                        content += '        <div class="left">代理审核：</div>';
                        content += '        <div class="right" style="color:green"><span style="color:gray !important">赖良坤</span>已审核</div>';
                        content += '    </div>';
                        content += '    <div class="rows8">';
                        content += '        <div class="left">经理审核：</div>';
                        content += '        <div class="right" style="color:green"><span style="color:gray !important">林展浩</span>已审核</div>';
                        content += '    </div>';
                        content += '    <div class="rows8">';
                        content += '        <div class="left">人事审核：</div>';
                        content += '        <div class="right" style="color:green">已审核</div>';
                        content += '    </div>';
                        content += '    <div class="rows8">';
                        content += '        <div class="left">领导审核：</div>';
                        content += '        <div class="right status1">未审核</div>';
                        content += '    </div>';

                        //content += '    <div class="rows8">';
                        //content += '        <div class="left">审核状态：</div>';
                        //content += '        <div class="right status2">完成</div>';
                        //content += '    </div>';
                    ...
                    if (obj.status == 1) {
                        ...
                        //content += '    <div class="rows8">';
                        //content += '        <div class="left">审核状态：</div>';
                        //content += '        <div class="right status1">已同意</div>';
                        //content += '    </div>';
                        content += '    <div class="rows10">';
                        content += '        <div class="left">代理审核：</div>';
                        content += '        <div class="right"">' + obj.susername + '<span style="color:red">已同意</span></div>';
                        content += '    </div>';
                        content += '    <div class="rows10">';
                        content += '        <div class="left">经理审核：</div>';
                        content += '        <div class="right"">林展浩<span style="color:red">已同意</span></div>';
                        content += '    </div>';
                        content += '    <div class="rows8">';
                        content += '        <div class="left">人事审核：</div>';
                        content += '        <div class="right status1">已同意</div>';
                    ...
                    if (obj.status == 6) {
                        ...
                        content += '    <div class="rows10">';
                        content += '        <div class="left">代理审核：</div>';
                        content += '        <div class="right"">杨晓龙<span style="color:red">已同意</span></div>';
                        content += '    </div>';
                        ...
                        content += '    <div class="rows10">';
                        content += '        <div class="left">人事审核：</div>';
                        content += '        <div class="right""><span style="color:red">已同意</span></div>';
                        content += '    </div>';
                        content += '    <div class="rows8">';
                        content += '        <div class="left">领导审核：</div>';
                        content += '        <div class="right status1">已驳回</div>';
                        content += '    </div>';
                        content += '    <div class="rows9">';
                        content += '        <div class="left">驳回原因：</div>';
                        content += '        <div class="right">节假日前后不能请假</div>';
                        content += '    </div>';
                        if (obj.delayedtime != "") {
                            content += '    <div class="rows10">';
                            content += '        <div class="left">延时原因：</div>';
